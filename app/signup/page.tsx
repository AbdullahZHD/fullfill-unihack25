      ...
      <div className="bg-background min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <Card className="max-w-md w-full bg-primary/10 border-primary/20">
          <CardHeader>
            ...
            <CardTitle className="text-center text-foreground">Registration Successful!</CardTitle>
            <CardDescription className="text-center">Your account has been created successfully</CardDescription>
          </CardHeader>
          <CardContent className="text-center">
            <p className="text-muted-foreground mb-6">
              You can now log in with your email and password to start sharing surplus food.
            </p>
    ...
    <div className="bg-background min-h-screen py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md mx-auto space-y-8">
        <div className="text-center">
          ...
          <p className="mt-2 text-muted-foreground">Create an account to share your surplus food</p>
        </div>
